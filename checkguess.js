...
const checkNumber = () => {
  ...
  if (userGuess == randomNumber) {
    ...
    guessStatus.innerHTML = "<strong>You are the one</strong>, because your guess of  " + randomNumber + " is the mystery number.<br />Take the red pill and let's see how deep the rabbit goes...";
